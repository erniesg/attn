  ...
  return (
    <div className="space-y-4" id="section1-the-medium">
      ...
      <p className="text-gray-700">
        ...
        that we tell about ourselves? This is a history-in-the-making moment for
        newsrooms to redefine their role as gatekeepers, curators, and
        interpreters of information. This strategic proposal outlines how Tech
        in Asia can lead the charge in creating an AI-Native newsroom, merging
        the power of cutting-edge algorithms with the timeless principles of
      ...
      <p className="text-gray-700">
        ...
        prioritised key strategic initiatives that will guide the transition to
        an AI-Native newsroom over a 3-year period. These initiatives, which
        range from automated content creation and fact-checking to personalised
        news digests and insight-driven story discovery, are designed to strike
