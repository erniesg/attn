...
export function Section6_ContentEngine() {
  return (
    <div className="space-y-4" id="section6-content-engine">
      ...
      <p>
        Interest in AI is not recent. An examination of Google search trends
        from 2004 shows “ai” to consistently outperform existing dedicated
        sections such as &quot;startups&quot;, &quot;ecommerce&quot;,
        fintech&quot; and &quot;crypto&quot; (&quot;greentech&quot; was excluded
        since its absolute value is minimal).
      </p>
      ...
      <p>
        Indeed, AI might be best characterised as a paradigm-shifting, general
        purpose foundational technology that allows humanity to scale
        intelligence and reasoning for the first time ever in history. This deep
        structural impact will play out over many years and across all levels of
        society, disrupting industries, creating new paradigms, and raising
        existential questions for us as a species.{' '}
        <a
      ...
      <p>
        As a result, AI will continue to dominate the global agenda for the
        foreseeable future with newsrooms playing a crucial role in shaping
        public understanding and fostering informed debate. The media will play
        a crucial role in helping to probe and to answer questions such as the
        ones below.
      </p>
      <div className="space-y-4">
        ...
        <div className="question-box" data-aos="fade-up">
          ...
          <p>
            Should I build my own Large Language Model? How should we deal with
            the global supply chain of talent and compute? What about ethics and
            regulation to ensure that our citizens come out on top?
          </p>
        </div>
      </div>
      <p>
