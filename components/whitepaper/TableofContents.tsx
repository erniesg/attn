  ...
  return (
    <div className="space-y-4">
      ...
      <nav className="space-y-2">
        ...
        <a
          className="block text-gray-700 hover:text-[#C0181F]"
          href="#section-2-market-quadrant-analysis"
        >
          2. Market Quadrant Analysis: Insights from 10 Media Outlets
        </a>
        <a
          className="block text-gray-700 hover:text-[#C0181F]"
          href="#section-3-swot-analysis"
        >
        ...
        <a
          className="block text-gray-700 hover:text-[#C0181F]"
          href="#section5-strategic-initiatives"
        >
          5. Strategic Initiatives: Roadmap to an AI-Native Newsroom
        </a>
        <a
          className="block text-gray-700 hover:text-[#C0181F]"
          href="#section6-content-engine"
        >
          6. Content Engine: Opportunities for an AI Desk
        </a>
        <a
          className="block text-gray-700 hover:text-[#C0181F]"
          href="#section-7-geography-and-conclusion"
        >
